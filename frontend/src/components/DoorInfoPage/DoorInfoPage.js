                        ...
                        <div className="door-info-left">
                            ...
                            <div className="door-info-bottom">
                                ...
                                {/*</div>*/}
                                    ...
                                    <div className="tabs">
                                        <label className="tab" id="one-tab" htmlFor="one">Характеристикі &nbsp;<FontAwesomeIcon
                                            icon={faChevronRight}/></label>
                                        <label className="tab" id="two-tab" htmlFor="two">Докладніше &nbsp;<FontAwesomeIcon
                                            icon={faChevronRight}/></label>
                                    </div>
                                    <div className="panels">
                                        <div className="panel" id="one-panel">
                                            ...
                                            <table className="char-table">
                                                <tbody>
                                                {door.deviator ? (
                                                    <tr><td>Девіатор</td><td>{door.deviator}</td></tr>
                                                ):null}
                                                <tr><td>Метал полотна</td><td>{door.canvasMetal}</td></tr>
                                                <tr><td>Метал рами</td><td>{door.frameMetal}</td></tr>
                                                <tr><td>Товщина полотна</td><td>{door.canvasThickness}</td></tr>
                                                <tr><td>Товщина рами</td><td>{door.frameThickness}</td></tr>
                                                <tr><td>Заповнення полотна і рами</td><td>{door.canvasFrameFilling}</td></tr>
                                                <tr><td>Зовнішня / внутрішня обробка</td><td>{door.externalInternalFinishing}</td></tr>
                                                {door.nightValue ? (
                                                    <tr><td>Нічна засувка</td><td>{door.nightValve}</td></tr>
                                                ):null}
                                                <tr><td>Петлі</td><td>{door.hinges}</td></tr>
                                                <tr><td>Протизнімні ригелі</td><td>{door.antiRemovableLedgers}</td></tr>
                                                <tr><td>Ущільнювач</td><td>{door.sealant}</td></tr>
                                                <tr><td>Основний замок</td><td>{door.mainLock}</td></tr>
                                                {door.additionalLock ? (
                                                    <tr><td>Додатковий замок</td><td>{door.additionalLock}</td></tr>
                                                ) :null}
                                                <tr><td>Накладка на поріг з нерж. сталі</td><td>Присутня</td></tr>
                                                <tr><td>Система захисту</td><td>{door.burglaryResistance}</td></tr>
                                                </tbody>
                                            </table>
                                        </div>
